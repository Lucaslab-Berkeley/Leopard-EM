...
Leopard-EM is a GPU-accelerated Python package for running Two-Dimensional Template Matching (2DTM) on cryo-EM data and building 2DTM into more complex workflows.
Leopard-EM is built with flexibility, extensibility, and reproducibility in mind.
2DTM is an emerging cryo-EM data processing method for locating _and_ orienting particles using a reference structure through exhaustive orientation sampling[^1]<sup>,</sup>[^2].
...
!!! info "Citing this work"

    If you use Leopard-EM in your research, please cite the [Leopard-EM pre-print](https://doi.org/10.1101/2025.08.26.672452).
    <!-- ```
...
[^1]: Lucas BA, Himes BA, Xue L, Grant T, Mahamid J, Grigorieff N. Locating macromolecular assemblies in cells by 2D template matching with cisTEM. Elife. 2021 Jun 11;10:e68946. doi: https://doi.org/10.7554/eLife.68946. PMID: 34114559; PMCID: PMC8219381.
[^2]: Leopard-EM: An extensible 2DTM package to accelerate in situ structural biology. Matthew David Giammar, Joshua Luke Dickerson, Laina Nicole Hall, Bronwyn Ayla Lucas. bioRxiv 2025.08.26.672452; doi: https://doi.org/10.1101/2025.08.26.672452