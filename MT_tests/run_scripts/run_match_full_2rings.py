...
YAML_CONFIG_PATH = str(MT_ROOT / "configs" / "match_tm_full_2rings.yaml")
CONSTRAINT_YAML_PATH = str(MT_ROOT / "configs" / "filament_constraint_full.yaml")
DATAFRAME_OUTPUT_PATH = str(
    MT_ROOT / "results_cropped" / "results_2rings_full.csv"
)
ORIENTATION_BATCH_SIZE = 8
STATS_FROM_VALID_ORIENTATIONS_DEFOCUS = False

_RESULT_PATHS = {
    "mip_path": "results_full/output_mip_2rings_full.mrc",
    "scaled_mip_path": "results_full/output_scaled_mip_2rings_full.mrc",
    "orientation_psi_path": (
        "results_full/output_orientation_psi_2rings_full.mrc"
    ),
    "orientation_theta_path": (
        "results_full/output_orientation_theta_2rings_full.mrc"
    ),
    "orientation_phi_path": (
        "results_full/output_orientation_phi_2rings_full.mrc"
    ),
    "relative_defocus_path": (
        "results_full/output_relative_defocus_2rings_full.mrc"
    ),
    "correlation_average_path": (
        "results_full/output_correlation_average_2rings_full.mrc"
    ),
    "correlation_variance_path": (
        "results_full/output_correlation_variance_2rings_full.mrc"
    ),
