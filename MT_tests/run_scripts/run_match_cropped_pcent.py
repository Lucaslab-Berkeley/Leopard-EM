...
YAML_CONFIG_PATH = str(MT_ROOT / "configs" / "match_tm_crop_pcent.yaml")
CONSTRAINT_YAML_PATH = str(MT_ROOT / "configs" / "filament_constraint_box.yaml")
DATAFRAME_OUTPUT_PATH = str(
    MT_ROOT / "results_cropped" / "results_pcent_constrained.csv"
)
ORIENTATION_BATCH_SIZE = 8
STATS_FROM_VALID_ORIENTATIONS_DEFOCUS = False

_RESULT_PATHS = {
    "mip_path": "results_cropped/output_mip_pcent_constrained.mrc",
    "scaled_mip_path": "results_cropped/output_scaled_mip_pcent_constrained.mrc",
    "orientation_psi_path": (
        "results_cropped/output_orientation_psi_pcent_constrained.mrc"
    ),
    "orientation_theta_path": (
        "results_cropped/output_orientation_theta_pcent_constrained.mrc"
    ),
    "orientation_phi_path": (
        "results_cropped/output_orientation_phi_pcent_constrained.mrc"
    ),
    "relative_defocus_path": (
        "results_cropped/output_relative_defocus_pcent_constrained.mrc"
    ),
    "correlation_average_path": (
        "results_cropped/output_correlation_average_pcent_constrained.mrc"
    ),
    "correlation_variance_path": (
        "results_cropped/output_correlation_variance_pcent_constrained.mrc"
    ),
    "correlation_table_path": (
        "results_cropped/output_correlation_table_pcent_constrained.h5"
    ),
}
