...
YAML_CONFIG_PATH = str(MT_ROOT / "configs" / "match_tm_crop_patch4.yaml")
CONSTRAINT_YAML_PATH = str(MT_ROOT / "configs" / "filament_constraint_box.yaml")
DATAFRAME_OUTPUT_PATH = str(
    MT_ROOT / "results_cropped" / "results_constrained_box.csv"
)
ORIENTATION_BATCH_SIZE = 8
STATS_FROM_VALID_ORIENTATIONS_DEFOCUS = False

_RESULT_PATHS = {
    "mip_path": "results_cropped/output_mip_constrained_box.mrc",
    "scaled_mip_path": "results_cropped/output_scaled_mip_constrained_box.mrc",
    "orientation_psi_path": (
        "results_cropped/output_orientation_psi_constrained_box.mrc"
    ),
    "orientation_theta_path": (
        "results_cropped/output_orientation_theta_constrained_box.mrc"
    ),
    "orientation_phi_path": (
        "results_cropped/output_orientation_phi_constrained_box.mrc"
    ),
    "relative_defocus_path": (
        "results_cropped/output_relative_defocus_constrained_box.mrc"
    ),
    "correlation_average_path": (
        "results_cropped/output_correlation_average_constrained_box.mrc"
    ),
    "correlation_variance_path": (
        "results_cropped/output_correlation_variance_constrained_box.mrc"
    ),
    "correlation_table_path": (
        "results_cropped/output_correlation_table_constrained_box.h5"
    ),
}
